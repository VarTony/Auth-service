 ...
 * @returns
 */
const replaceSpecialSymbols = (b64UrlString) =>
  b64UrlString
    .split('')
 ...
 * @returns
 */
const fromBase64 = async (value: string) =>
 ...
 * @returns
 */
const fromBase64Url = async (value: string) =>
  await fromBase64(replaceSpecialSymbols(value));
